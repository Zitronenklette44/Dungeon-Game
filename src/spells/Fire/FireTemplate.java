...
public class FireTemplate extends SpellTemplate{

	public FireTemplate(float posX, float posY, float dx, float dy, String Type, int Stage, int damage, int manaConsume,
