...
public class Normal extends RoomTemplate {
    private String[] image = {"/resources/rooms/backgrounds/VillagePath1.png", "/resources/rooms/backgrounds/VillagePath2.png"}; 
    ...
    private void createNewNormal(int currentRoom) {
        ...
        System.out.println("New room created with variant: " + variante);
    }
    ...
    public void createObjects(int currentRoom) { 
        ...
        System.out.println("Creating objects for variant: " + variant);
        switch (variant) {
            case 0: {
                ...
                CreateObjects.createHitbox(250, 48, 840, 430);
                break;
            }
            case 1:
                System.out.println("Case 1 logic here");
                break;
            case 2:
