...
public class ShopPotions extends JFrame {
	...
	public ShopPotions() {
        ...
        JLabel lblNewLabel_2 = new JLabel(Translation.get("shopPotion.health1")+":                                                                                                    XCoins");
        ...
        JLabel lblNewLabel_2_1 = new JLabel(Translation.get("shopPotion.damage1")+":                                                                                                    XCoins");
        ...
        JLabel lblNewLabel_2_2 = new JLabel(Translation.get("shopPotion.speed1")+":                                                                                                    XCoins");
